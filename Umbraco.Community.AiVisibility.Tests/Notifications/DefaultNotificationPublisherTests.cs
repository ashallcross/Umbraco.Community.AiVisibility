...
public class DefaultLlmsNotificationPublisherTests
{
    ...
    private DefaultNotificationPublisher _publisher = null!;
    ...
    public void Setup()
    {
        ...
        _publisher = new DefaultNotificationPublisher(
            _aggregator,
            _classifier,
            NullLogger<DefaultNotificationPublisher>.Instance);
    }
    ...
    public void ExtractReferrerHost_NullOrEmpty_ReturnsNull()
    {
        Assert.Multiple(() =>
        {
            Assert.That(DefaultNotificationPublisher.ExtractReferrerHost(null), Is.Null);
            Assert.That(DefaultNotificationPublisher.ExtractReferrerHost(""), Is.Null);
            Assert.That(DefaultNotificationPublisher.ExtractReferrerHost("   "), Is.Null);
        });
    }
    ...
    public void ExtractReferrerHost_AbsoluteUrl_ReturnsHostOnly_NoPathOrQuery()
    {
        ...
        Assert.That(
            DefaultNotificationPublisher.ExtractReferrerHost(
    ...
    {
        Assert.That(
            DefaultNotificationPublisher.ExtractReferrerHost("not a url at all"),
            Is.Null);
    }
}
