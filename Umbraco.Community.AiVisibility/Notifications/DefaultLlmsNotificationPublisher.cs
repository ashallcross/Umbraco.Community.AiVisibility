...
/// <summary>
/// Story 5.1 — default <see cref="ILlmsNotificationPublisher"/>. Singleton
...
/// never propagate.
/// </remarks>
public sealed class DefaultLlmsNotificationPublisher : ILlmsNotificationPublisher
{
    private readonly IEventAggregator _eventAggregator;
    private readonly IUserAgentClassifier _classifier;
    private readonly ILogger<DefaultLlmsNotificationPublisher> _logger;

    public DefaultLlmsNotificationPublisher(
        IEventAggregator eventAggregator,
        IUserAgentClassifier classifier,
        ILogger<DefaultLlmsNotificationPublisher> logger)
    {
